...
/*
     ласс экспорта игровой линии, кроссворда или теста палитры в png-файл (Qt).
—оздан дл¤ отладки алгоритмов (сброс в файл промежуточных ситуаций).
Todo: цвет клетки задани¤ дл¤ немонохромной задачи нужно окрашивать
*/
